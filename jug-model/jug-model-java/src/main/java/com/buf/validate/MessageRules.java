...
private static final long serialVersionUID = 0L;
  ...
  public static final int CEL_EXPRESSION_FIELD_NUMBER = 5;
   ...
   * </pre>
   *
   * <code>repeated string cel_expression = 5 [json_name = "celExpression"];</code>
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    for (int i = 0; i < celExpression_.size(); i++) {
      com.google.protobuf.GeneratedMessageV3.writeString(output, 5, celExpression_.getRaw(i));
    }
  ...
  public int getSerializedSize() {
    ...
    }
    {
      ...
      size += dataSize;
      size += 1 * getCelExpressionList().size();
    }
