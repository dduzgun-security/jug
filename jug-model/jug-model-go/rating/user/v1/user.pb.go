...
const file_rating_user_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x19rating/user/v1/user.proto\x12\x0erating.user.v1\x1a\x1bbuf/validate/validate.proto\"\xae\x03\n" +
	"\x04User\x12)\n" +
	"\n" +
	...
	"\x03age\x18\x04 \x01(\rB\v\xbaH\b\xc8\x01\x01*\x03\x18\x96\x01R\x03age\x12G\n" +
